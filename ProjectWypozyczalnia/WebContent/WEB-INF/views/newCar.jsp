...
<body>
 <div id="container">
		<div id="header">
         ...
         <div id="menu">
        	<ul>
            	<li class="menuitem" > <a class="nav-link  active" aria-current="page" href='<c:url value="/logout"></c:url>'>Wyloguj się</a></li>
            </ul>
        </div>
        

 	<h5 class="text-warning" ><c:out value="${info} "></c:out></h5>
	<h2 style="text-align:center;" >Nowy<span class="off">pojazd</span></h2>
