...
<body>
 <div id="container">
	...
	<h2 style="text-align:center;" >Edycja<span class="off">użytkownika</span></h2>
     ...
     <form:form action="editUser" modelAttribute="user" method="post">
        <table align="center" style="padding-top: 30px">
         ...
         <td><form:input type="text" path="email" class="form-control" id="email" aria-describedby="emailHelp"/></td>
         </tr>
         <tr>
         <td><label for="username">Login</label></td>
         <td> <form:input type="text" path="userName" class="form-control" id="username" aria-describedby="emailHelp"/></td>
         </tr>
         <tr>
         <td><label style="color:black" for="password">Hasło</label></td>
         <td> <form:input type="password" path="password" class="form-control" id="password"/></td>
         </tr>
        </table>
